...
class Configuration {
    ...
    internal fun sagaManager(
        ...
        aggregate: StateStoredAggregate<Either<RestaurantOrderCommand?, RestaurantCommand?>, Pair<RestaurantOrder?, Restaurant?>, Either<RestaurantOrderEvent?, RestaurantEvent?>>
    ) = sagaManager(
        restaurantSaga,
        restaurantOrderSaga,
    ...
    internal fun commandBus(
        aggregate: StateStoredAggregate<Either<RestaurantOrderCommand?, RestaurantCommand?>, Pair<RestaurantOrder?, Restaurant?>, Either<RestaurantOrderEvent?, RestaurantEvent?>>,
        sagaManager: SagaManager<Either<RestaurantEvent?, RestaurantOrderEvent?>, Either<RestaurantOrderCommand?, RestaurantCommand?>>
