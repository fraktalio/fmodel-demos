...
internal fun sagaManager(
    ...
    actionPublisher: ActionPublisher<Either<RestaurantOrderCommand?, RestaurantCommand?>>
) = SagaManager<Either<RestaurantEvent?, RestaurantOrderEvent?>, Either<RestaurantOrderCommand?, RestaurantCommand?>>(
    saga = restaurantSaga.combineSagas(restaurantOrderSaga),
