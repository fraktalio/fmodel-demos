...
import com.fraktalio.fmodel.example.statestoredsystem.domain.Restaurant.RestaurantMenu
import com.fraktalio.fmodel.example.statestoredsystem.domain.Restaurant.Status
import java.util.*
 ...
 */
internal fun restaurantDecider() = Decider<RestaurantCommand?, Restaurant?, RestaurantEvent?>(
    initialState = null,
...
internal data class Restaurant(
    ...
    internal data class MenuItem(val id: String, val name: String, val price: Money)

    internal enum class MenuStatus {
        ACTIVE,
        PASSIVE
    }

    internal data class RestaurantMenu(
        val menuId: UUID,
