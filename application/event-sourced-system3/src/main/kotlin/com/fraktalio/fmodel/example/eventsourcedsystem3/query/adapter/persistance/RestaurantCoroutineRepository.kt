...
package com.fraktalio.fmodel.example.eventsourcedsystem3.query.adapter.persistance
...
internal data class RestaurantR2DBCEntity(
    ...
    val name: String,
    val status: RestaurantViewState.Status,
    val cuisine: RestaurantMenuCuisine,
    val menuStatus: RestaurantViewState.MenuStatus,
    val menuId: String,
